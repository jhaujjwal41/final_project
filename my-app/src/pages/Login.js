...
function Login({user, setUser} ) {
    ...
    const LoginUser = async ()=>{
        ...
        const response = await fetch('http://172.25.27.106:3000/user/login',{
            method:'POST',
            headers: {
      ...
      <div className="min-h-screen sm:flex sm:flex-row mx-0 justify-center">
          ...
          <div className="flex justify-center self-center  z-10">
            <div className="p-12 bg-white mx-auto rounded-2xl w-100 ">
                ...
                <div>
                  <button onClick={LoginUser} type="submit" className="w-full flex justify-center bg-green-400  hover:bg-green-500 text-gray-100 p-3  rounded-full tracking-wide font-semibold  shadow-lg cursor-pointer transition ease-in duration-500">
                    Sign in
                  </button>
                </div>
                
                 <Link to= "/SignUp"> <span>Don't Have a account? SignUp</span> </Link>
